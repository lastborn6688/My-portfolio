...
const NavBar = () => {
  ...
  return (
    <div className="fixed top-5 rounded-full ml-0 lg:ml-32 h-20 w-screen lg:w-[80%] bg-black/30 backdrop-blur-md z-50 flex justify-between items-center px-6 text-white">
