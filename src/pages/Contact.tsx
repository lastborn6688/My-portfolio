...
const Contact = () => {
  return (
    <div className="bg-gradient-to-b to-[rgb(29,39,54)] via-gray-700 from-gray-800 w-full h-full p-4 text-white">
      <div className="flex flex-col p-4  justify-center max-w-screen-lg mx-auto h-full">
        ...
        <div className="flex justify-center  items-center">
          ...
          >
            ...
            ></textarea>
            <button className="bg-black shadow-gray-50 shadow-lg group relative border-white hover:bg-gray-800 overflow-hidden transition-all text-white px-6 py-3 my-8 mx-auto items-center rounded-md hover:scale-110 duration-300">
